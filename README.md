...
applications. Proficient in Java, Selenium, TestNG, Cucumber BDD, Maven, JUnit, Jenkins, Postman, and Rest Assured.
Skilled in database testing with MySQL and JDBC and well-versed in version control tools such as Git/GitHub. A former
accountant with strong analytical and problem-solving skills, leveraging expertise in financial systems and processes to
streamline workflows and ensure accuracy in Agile/Scrum environments. Brings exceptional attention to detail and a deep
understanding of regulatory and compliance requirements to the IT field.
<img src="https://www.animatedimages.org/data/media/562/animated-line-image-0184.gif" width="1920" />
